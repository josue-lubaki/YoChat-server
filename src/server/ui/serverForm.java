...
import static server.handlers.ClientHandler.notifyEveryClient;
...
import server.handlers.ServerStart;
...
public class serverForm extends javax.swing.JFrame {
        ...
        protected void btnRefreshActionPerformed(ActionEvent e) {
                ...
                try {
                        ...
                        setIconImage(new ImageIcon("src/resources/images/server-run.png").getImage());
                } catch (Exception ex) {
